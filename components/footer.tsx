...
import { ShoppingCart, Mail, Shield, CreditCard } from "lucide-react"
    ...
    <footer className="bg-secondary pt-12 pb-6">
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-1">
            ...
            <p className="text-muted-foreground text-sm mb-4">
              Seu marketplace confiável para contas Roblox. Produtos de qualidade e entrega imediata.
            </p>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              <li className="flex items-start">
                ...
                <span className="text-muted-foreground">contato@thebuxx.com</span>
              </li>
          ...
          <div className="col-span-1">
            ...
            <div className="flex flex-wrap gap-2 mb-4">
              <div className="bg-white p-2 rounded w-16 h-10 flex items-center justify-center">
                <CreditCard className="h-6 w-6 text-gray-800" />
              </div>
              <div className="bg-white p-2 rounded w-16 h-10 flex items-center justify-center text-sm font-bold text-gray-800">
                PIX
              </div>
            </div>
        ...
        <div className="pt-6 border-t border-border text-center">
          <p className="text-muted-foreground text-sm">&copy; {currentYear} TheBuxx. Todos os direitos reservados.</p>
        </div>
      </div>
    </footer>
  )
